...
$email	=$_SESSION["user"];	
	...
	$stat1= $conn->prepare("SELECT  `name`, `password`, `dob`, `gender`, `city`, `about`, `DPpath` FROM `users` WHERE `email` = ? ");
	$stat1->bind_param("s",$email);
	$stat1->execute();
	$stat1->bind_result( $name, $pwd, $dob, $gender, $city, $about ,$path);
	$stat1->fetch();
...
?>
	...
	<div class="col-md-3" id="timelineFeatured">	
		<div class="well" id="featuredHeading" style="background-color: black; color:white">
				
		<h4>Featured Posts</h4>
	</div>
	<div class="well">
		<a href="fp1.html" class="btn btn-primary" id="featuredPostTitle" style="width: 100%;">Completed vs. Died by                    s</a>
	</div>
	<div class="well">	
		<a href="fp2.html" class="btn btn-primary" id="featuredPostTitle" style="width: 100%;">Suicidal Thoughts          </a>
	</div>
	<div class="well">
		<a href="fp3.html" class="btn btn-primary" id="featuredPostTitle" style="width: 100%;">Suicide prevention                   </a>
	</div>		
	</div>
</div>
<br><br><br>
